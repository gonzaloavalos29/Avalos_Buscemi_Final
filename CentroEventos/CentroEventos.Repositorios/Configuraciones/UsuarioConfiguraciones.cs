...
public class UsuarioConfiguraciones : IEntityTypeConfiguration<Usuario>
{
    public void Configure(EntityTypeBuilder<Usuario> builder)
    {
        ...
        builder.Property(u => u.permisos).HasConversion(v => JsonSerializer.Serialize(v, (JsonSerializerOptions)null),v => JsonSerializer.Deserialize<List<Permiso>>(v, (JsonSerializerOptions)null)
        );
    }
}